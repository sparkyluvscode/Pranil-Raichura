...
import { personalInfo, leadershipPositions } from "@/data/personal";
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <Link href="/">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="flex items-center gap-2 px-6 py-3 bg-white/10 backdrop-blur-md rounded-full border border-white/20 hover:bg-white/20 transition-all duration-200 text-white font-medium shadow-lg"
            >
              <svg
                className="w-5 h-5"
                fill="none"
        ...
        >
          <div className="flex items-center mb-8">
            ...
            <h2 className="text-2xl md:text-3xl font-bold">Leadership Positions</h2>
          </div>
        ...
        >
          <Link href="/">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="px-8 py-4 bg-white text-primary-600 rounded-full font-semibold text-lg shadow-xl hover:shadow-2xl transition-all duration-200"
            >
              Learn More About Me →
            </motion.button>
          </Link>
